...
@section('title', 'Create Consignment')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h1 class="h3 mb-0">Create New Consignment</h1>
            <p class="text-muted">Add a new consignment to the system</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.consignments.store') }}" class="needs-validation" novalidate>
        @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('consignment_number', 'CN' . date('Ymd') . rand(1000, 9999)) }}" 
                                       required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('consignment_date', date('Y-m-d')) }}" 
                                       required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('consignor_id') is-invalid @enderror" 
                                ...
                                @foreach($consignors as $consignor)
                                    <option value="{{ $consignor->id }}" {{ old('consignor_id') == $consignor->id ? 'selected' : '' }}>
                                        {{ $consignor->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select @error('truck_type') is-invalid @enderror" 
                                    ...
                                    <option value="Mini Truck" {{ old('truck_type') == 'Mini Truck' ? 'selected' : '' }}>Mini Truck</option>
                                    <option value="Tata 407" {{ old('truck_type') == 'Tata 407' ? 'selected' : '' }}>Tata 407</option>
                                    <option value="Tata 709" {{ old('truck_type') == 'Tata 709' ? 'selected' : '' }}>Tata 709</option>
                                    <option value="Tata 1109" {{ old('truck_type') == 'Tata 1109' ? 'selected' : '' }}>Tata 1109</option>
                                    <option value="Tata 1613" {{ old('truck_type') == 'Tata 1613' ? 'selected' : '' }}>Tata 1613</option>
                                    <option value="Tata 2518" {{ old('truck_type') == 'Tata 2518' ? 'selected' : '' }}>Tata 2518</option>
                                    ...
                                    <option value="Other" {{ old('truck_type') == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                                @error('truck_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('delivery_office_address') is-invalid @enderror" 
                                          ...
                                          rows="2" 
                                          required>{{ old('delivery_office_address') }}</textarea>
                            ...
                            <div class="item-row border rounded p-3 mb-3">
                                <div class="row g-3">
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" 
                                               class="form-control" 
                                               name="items[0][package_count]" 
                                               min="1" 
                                               required>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">Package Type</label>
                                        <select class="form-select" name="items[0][package_type]">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select @error('payment_mode') is-invalid @enderror" 
                                    ...
                                    <!-- <option value="advance" {{ old('payment_mode') == 'advance' ? 'selected' : '' }}>Advance</option> -->
                                    <option value="to be billed" {{ old('payment_mode') == 'to be billed' ? 'selected' : '' }}>To be Billed</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           name="at_owners_risk" 
                                           value="1" 
                                           {{ old('at_owners_risk') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="at_owners_risk">
                                        At Owner's Risk
                                    </label>
                                </div>
                            </div>
